...
class ImageAnalyzer:
    def __init__(self, filepath, min_track_length=3, max_linking_distance=15, max_gap_closing=2, max_gap_distance=15):
        """
    ...
    def track_objects(self, min_track_length=None, max_linking_distance=None, max_gap_closing=None, max_gap_distance=None):
        """
        ...
        max_gap_closing : int, optional
            Override the default max_gap_closing
        max_gap_distance : float, optional
            Override the default max_gap_distance
        ...
        gap_closing = max_gap_closing if max_gap_closing is not None else self.max_gap_closing
